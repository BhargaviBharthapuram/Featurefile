@regressions
Feature: Validate the Functionality of Email ID on contact us page

  @tag1
  Scenario: Verify the functionality of Email ID
    ...
    #161
    And Now click the Email ID and verify the functionality
